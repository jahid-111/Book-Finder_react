<div className="space-y-3 bg-red-200 ">
  <div className="flex items-center justify-center rounded-md border border-[#324251]/30 bg-white p-4">
    <img
      className="w-full"
      src="https://elearningindustry.com/wp-content/uploads/2016/05/top-10-books-every-college-student-read-e1464023124869.jpeg"
      alt="book name"
    />
  </div>
  ...
  <div className="space-y-3">
    <h4 className="text-lg font-bold lg:text-xl">JavaScript and Jquerydcad</h4>
